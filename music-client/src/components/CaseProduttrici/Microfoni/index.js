...
/* Codice per la pagina delle case produttrici di microfoni */
...
const CaseProdMicrofoniElement = () => {
    ...
    useEffect( () => {
        /* Costruzione della SPARQL Query per ricercare i dati di tutte le case produttrici di microfoni */
        const requestData = {
            query:  "PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#>\n" +
                    ...
                    "    ?casaProdMicrofoni music:Immagine ?immagine .\n" +
                    "    ?casaProdMicrofoni music:FondataNel ?dataFond .\n" +
                    "    ?casaProdMicrofoni music:ubicataIn ?citta .\n" +
...
export default CaseProdMicrofoniElement