...
/* Codice per la pagina dei batteristi */

const BatteristiElement = () => {
    ...
    useEffect( () => {
        const requestData = {
            /* Costruzione della SPARQL Query per ricercare i dati di tutti i batteristi */
            query:  "PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#>\n" +
                    ...
                    "SELECT DISTINCT ?batterista ?nome ?dataNascita ?genere ?eta ?cognome ?immagine ?bandURI ?groupband ?lavoraIn (group_concat(distinct ?strumentoMusicaleURI;separator=\", \") AS ?suonaURI) (group_concat(distinct ?oggetto;separator=\", \") AS ?suonaCon) (group_concat(distinct ?strumentoMusicale;separator=\", \") AS ?suona) where{\n" +
                    "    ?batterista rdf:type music:Batterista .\n" +
                    "    ?batterista foaf:firstName ?nome .\n" +
                    "    ?batterista foaf:lastName ?cognome .\n" +
                    "    ?batterista foaf:birthday ?dataNascita .\n" +
                    "    ?batterista foaf:age ?eta .\n" +
                    "    ?batterista foaf:gender ?genere .\n" +
                    "    ?batterista music:Immagine ?immagine .\n" +
                    "    ?batterista music:lavoraIn ?bandURI .\n" +
                    ...
                    "    ?batterista music:suona ?strumentoMusicaleURI .\n" +
                    ...
                    "    }\n" +
                    "}\n" +
                    "GROUP BY ?batterista ?nome ?dataNascita ?genere ?eta ?cognome ?immagine ?bandURI ?groupband ?lavoraIn",
            infer: true,
            sameAs: true
        }
    ...
    return (
        ...
        <ResultsContainer>
            <ResultsH1>Batteristi</ResultsH1>
                ...
                */
                return(
                    ...
                    <ItemDescription>
                        ...
                        <p>{item.nome.value + " " + item.cognome.value} suona {strumenti.length !== 1 ? "le batterie" : "la batteria"}:
                            <ul>
...
export default BatteristiElement
